...
const siteLogoURI = `${config.serverhost}:${config.port}/logo.png`

export default function resent(data) {
    return '<div>\
                                        ...
                                        <tbody>\
                                            <tr>\
                                                <td valign="middle" align="center" style="padding:20px 0;">\
                                                    <div><img src="'+ siteLogoURI +'" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none; background-color: red;"></div>\
                                                </td>\
                                            </tr>\
                                        </tbody>\
                                    </table>\
                                        ...
                                        <tbody>\
                                            <tr>\
                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #666666; text-align:left;line-height: 24px;">\
                                                    <p>Hello ' + data.name + ',</p>\
                                                    <p>Use ' + data.otp +' OTP to verify your account.</p>\
                                                </td>\
                                            </tr>\
                                            <tr>\
                                                <td width="100%" height="5"></td>\
